...
def clasificar_terreno(vh, vv):
    """Clasifica terreno en 5 capas independientes"""
    ...
    # Capa 1: Agua pura (lagunas, mar, ríos)
...
def main():
    ...
    ruta_geotiff2 = os.getenv("RUTA_GEOTIFF2")
